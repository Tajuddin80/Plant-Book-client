    ...
    <div className="mx-auto max-w-md p-4 my-20 rounded-md shadow sm:p-8 bg-base-100 text-base-content">
      ...
      <div className="my-6 space-y-4">
        <button
          ...
          type="button"
          className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md border-base-content/20 hover:border-base-content focus:ring-2 focus:ring-offset-1"
        >
